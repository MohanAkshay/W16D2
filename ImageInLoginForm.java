...
public class ImageInLoginForm extends Application{
	...
	{	
		...
		btnSubmit.setLayoutX(50); btnSubmit.setLayoutY(200);
		
		btnSubmit.setOnAction((event) -> { submitAction(); });
		
		
		btnExit.setLayoutX(300); btnExit.setLayoutY(200);
		
		lblMessage.setLayoutX(130); lblMessage.setLayoutY(300);
		lblMessage.setFont(Font.font("Arial",24));
		
		// Set the path for the image.  

	     Image image1 = new Image("desktop\\123.png");
		...
		theRoot.getChildren().addAll(lblHead, lblUserId,lblPass,txtUserId,txtPass,
              btnSubmit,btnExit,lblMessage,imageView);
		//,datePicker);
		//,);
	...
	@Override 
      ...
      UInterface(theRoot);
		Scene scene = new Scene(theRoot,400,400); //Creating a scene object
	...
	public void submitAction() {
		...
		if(checkUser.equals("rajeev") && checkPw.equals("123") || 
				checkUser.equals("akshay") && checkPw.equals("567")	){
		      lblMessage.setText("Congratulations!");
		      
		      lblMessage.setTextFill(Color.GREEN);
		      Stage theStage = new Stage();
		      theStage.setTitle("This is Other Screen");				// Label the stage (a window)
